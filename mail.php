...
<main>
  <article>
	...
	<div id="formWrap">
		...
		<?php }else{ ?>
			<h3>以下の内容で間違いがなければ、「送信する」ボタンを押してください。</h3>
			<form action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" method="POST">
				...
				<input type="button" class="sendBtn" value="前画面に戻る" onClick="history.back()"></p>
			</form>
		<?php } ?>
	</div><!-- /formWrap -->
<!-- ▲ *********** 送信内容確認部　※編集は自己責任で ************ ▲-->
